  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-col gap-8 ">
        ...
        <Insurance.ArchitectureBenefits architecture={architecture} benefits={businessBenefits} />

        {/* Why Arcin IT & Delivery Model (Image 3) */}
        <Insurance.DeliveryModel whyArcinit={whyArcinit} deliveryModel={deliveryModel} />
