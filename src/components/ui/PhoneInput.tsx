        ...
        <div className="flex gap-2">
          ...
          <div className="relative w-32">
            <select
              ...
              className="w-full cursor-pointer appearance-none rounded-xl border border-slate-200 bg-white py-3 pr-8 pl-10 text-sm text-slate-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
            >
          ...
          <div className="relative flex-1">
            <input
              ...
              placeholder=" "
              required={required}
              className="peer block w-full rounded-xl border border-slate-200 bg-white px-4 pt-5 pb-2 text-sm text-slate-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
            />
